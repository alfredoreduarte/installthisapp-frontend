		...
		<div className="col-md-6">
			...
			<table style={{
				...
				<tr>
					...
					<td style={styles.td}>
						{!steps[0] ? <span>Add some <b>products</b></span> : <s>Add some <b>products</b></s>}
					</td>
					<td style={styles.td}>
						<Link className={`btn btn-block ${!steps[0] ? 'btn-primary' : 'btn-default'}`} to={`/d/apps/${type}/${checksum}/products`}>Create your first product</Link>
					</td>
				</tr>
				<tr>
					<td style={styles.td}>
				...
				<tr>
					...
					<td style={styles.td}>
						{!steps[2] ? <span><b>Publish</b> the catalog</span> : <s><b>Publish</b> the catalog</s>}
					</td>
					<td style={styles.td}>
						{steps[2] ? 
			...
			<p className="text-right" style={{marginTop: '16px'}}>
				<small>Need help? Maybe our <a href="http://help.installthisapp.com/memory-match" target="_blank" rel="noopener">knowledge center</a> has some answers.</small>
			</p>
		</div>
		{false ? 
			<div className="col-md-6">
