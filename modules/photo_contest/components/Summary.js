		...
		<div className="col-md-6">
			...
			<table style={{
				...
				<tr>
					...
					<td style={styles.td}>
						<Link className={`btn btn-block ${!steps[0] ? 'btn-primary' : 'btn-default'}`}  to={`/d/apps/${type}/${checksum}/design`}>Open design editor</Link>
					</td>
				</tr>
				<tr>
					<td style={styles.td}>
					...
					<td style={styles.td}>
						{!steps[1] ? <span><b>Publish</b> the contest</span> : <s><b>Publish</b> the contest</s>}
					</td>
					<td style={styles.td}>
						{steps[1] ? 
			...
			<p className="text-right" style={{marginTop: '16px'}}>
				<small>Need help? Maybe our <a href="http://help.installthisapp.com/photo-contest" target="_blank">knowledge center</a> has some answers.</small>
			</p>
		</div>
		{false ? 
			<div className="col-md-6">
