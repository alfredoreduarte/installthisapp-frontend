		...
		<div className="col-md-6">
			...
			<table style={{
				...
				<tr>
					...
					<td style={styles.td}>
						{!steps[0] ? <span>Add some <b>cards</b></span> : <s>Add some <b>cards</b></s>}
					</td>
					<td style={styles.td}>
						<Link className={`btn btn-block ${!steps[0] ? 'btn-primary' : 'btn-default'}`} to={`/d/apps/${type}/${checksum}/cards`}>Create cards</Link>
					</td>
				</tr>
				<tr>
					<td style={styles.td}>
