...
let InvalidForm = ({ active, selectedValues, onTitleClick }) => (
	<div className={`editor-tab-item ${active && 'active'}`}>
		...
		<div className="editor-tab-item-body">
			...
			<div className="form-group">
				...
				<Field className="form-control" name={'messages.invalidCopy'} component="textarea" />
			</div>
		</div>
	</div>
)

InvalidForm = reduxForm({
...
export default connect(mapStateToProps, mapDispatchToProps)(InvalidForm)
