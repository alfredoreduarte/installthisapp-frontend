      ...
      <Modal
        ...
        <div
          ...
          <div
            ...
            {showDestinationSuccessModal.destinationType == 'email' ? <FaEnvelope size="50" style={{ color: 'white' }} /> : null}
            {showDestinationSuccessModal.destinationType == 'webhook' ? <MdCloud size="50" style={{ color: 'white' }} /> : null}
