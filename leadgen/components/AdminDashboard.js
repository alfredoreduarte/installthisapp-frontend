  ...
  <div>
    ...
    {!fbProfile ? (
      ...
      <div>
        <div className="col-md-12 text-center" style={{ marginBottom: '40px' }}>
          <p>
            <FbPhoto identifier={parseInt(fbProfile.identifier)} width={42} height={42} className="img-circle" />
          </p>
          <h4>
            <b>{fbProfile.name}</b>
          </h4>
        ...
        {fbLeadforms.length == 0 && !connectingToFacebook ? (
          <div className="col-md-12 text-center">
            <StepLabel number={1} />
            <h3>
              Create a <i>Source</i> <br />
              <small>
                <i>noun</i> | one of your Facebook Leadgen Forms
              </small>
            </h3>
          </div>
        ) : null}
              ...
              <FlipCard disabled={true} flipped={sourcesFormVisible || !fbLeadforms.length} style={{ width: '100%' }}>
                <div>
                  <div
                    ...
                    <button className="btn btn-primary btn-sm" onClick={showSourcesForm}>
                      Add Form
                    </button>
                  </div>
                ...
                <div className="panel panel-default">
                  <div className="panel-body">
                    <div
                      className={!fbLeadforms.length ? 'hide' : null}
                      style={{
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'space-between',
                  ...
                  {fbLeadforms.length == 0 ? (
                    <p className="text-center">
                      <small>
                        <a href="http://blog.installthisapp.com/creating-facebook-lead-ads/" target="_blank" rel="noopener">
                          What is a Facebook Leadgen Form?
                        </a>
                      </small>
                    </p>
                  ) : null}
    ...
    <svg className="hide" width="224" height="660">
      <g fill="none" stroke="#dfe4e9" strokeOpacity="0.52">
        <path d="M0,330.6C89.60000000000001,330.6, 134.4,30.6 224,30.6" strokeWidth="3.5999999999999996" />
      </g>
    </svg>
  </div>
)
