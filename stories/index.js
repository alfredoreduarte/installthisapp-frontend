...
storiesOf('Catalog Mobile Menu', module)
	.add('Basic', () => (
		<CatalogMobileMenu options={[{key: 'clothing', value: 'Clothing'}, {key: 'home', value: 'Home Appliances'}]} />
	))
storiesOf('Catalog Mobile TopBar', module)
	.add('Basic', () => (
		<CatalogMobileTopBar logoImage="https://localhost.ssl:5000/images/logo-round.png" homeUrl="#" />
	))
storiesOf('Catalog Desktop TopBar', module)
	.add('Basic', () => (
		<CatalogDesktopTopBar copy="Phone: 021 123 456" />
	))

storiesOf('Catalog Desktop Footer', module)
	.add('Basic', () => (
		<CatalogDesktopFooter copy="© 2017 - My Store - All rights reserved" />
	))

storiesOf('CatalogProduct', module)
	.add('Basic', () => (
		<CatalogProduct 
