		...
		return (
			<div style={styles.main}>
				...
				<p>
					...
					<br/>
					Have a look at the <a style={styles.link} href="https://github.com/kadirahq/react-storybook" target="_blank" rel="noopener">React Storybook</a> repo for more information.
				</p>
			</div>
		);
	}
