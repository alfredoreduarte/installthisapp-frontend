				...
				{currentUserName ? (
					<div>
						<div className="visible-xs visible-sm hidden-md hidden-lg text-center row">
							...
							<button onClick={() => getSingleUserScores()} className="btn btn-default ita-cali-update-button">
								{updateLabel}
							</button>
						</div>
						<div className="hidden-xs hidden-sm visible-md visible-lg">
							<div className="pull-left" style={{ marginRight: '20px' }}>
								<FbPhoto identifier={currentUserIdentifier} width={100} height={100} className="img-circle" />
							</div>
					...
					<div>
						<div className="visible-xs visible-sm hidden-md hidden-lg text-center">
							...
							<Link to={`/top_fans/${window.checksum}/login`} className="btn btn-default ita-cali-login-button">
								{signInLabel}
							</Link>
						</div>
						<div className="hidden-xs hidden-sm visible-md visible-lg">
