...
export const getCurrentApp = createSelector(getAllApps, getCurrentAppChecksum, (apps, checksum) =>
  _.find(apps, app => app.checksum == checksum)
)

export const getCurrentAppByState = createSelector(getAllApps, getCurrentAppChecksumByState, (apps, checksum) =>
  _.find(apps, app => app.checksum == checksum)
)

export const getAppToBeDeleted = createSelector(getAllApps, getAppToBeDeletedChecksum, (apps, checksum) =>
  _.find(apps, app => app.checksum == checksum)
)

export const getAllAppsByText = createSelector(getAllApps, getFilterText, appsSorterSelector, (apps, text, appsSorting) => {
