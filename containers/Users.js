...
const Users = ({ users, selectedItems, sortBy, handleUserSelect, handleUserSelectBatch, handleSort }) => (
				...
				<div className="col-md-3 col-md-offset-9">
					<div className="ita-table-view-second-row">
						<Select
							...
							value={sortBy}
							options={[{ value: 'name', label: 'Alphabetically' }, { value: 'createdAt', label: 'Most Recent' }]}
