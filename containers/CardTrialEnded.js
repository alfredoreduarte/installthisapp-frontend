		...
		<div className="animated fadeInDown" style={{
			...
			<div style={{
				...
				<a href="/d" style={{
					...
					top: '20px',
					right: '20px',
				}}><FaClose size={22} color={'rgba(0,0,0,.3)'} /></a>
				<h1 style={{
					textAlign: 'center',
				}}>Upgrade now and keep your contests running</h1>
				<p style={{
					textAlign: 'center',
				}}>Start now, pay next week. Cancel whenever you want.</p>
			</div>
			<div style={{display: 'flex', alignItems: 'center'}}>
				<div className="col-md-6 text-center">
					...
					<h5 style={{
						...
						marginBottom: '0px',
						opacity: .5
					}} className="text-uppercase"><b>Start now<br/>Pay later</b></h5>
				</div>
