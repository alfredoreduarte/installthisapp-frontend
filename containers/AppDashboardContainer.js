  ...
  <div>
    <Modal
      ...
      <div className="col-md-3 col-md-offset-3">
        <FacebookShareButton className="btn btn-fb btn-block" url={`https://${window.location.host}/gateway/${currentApp.checksum}`}>
          Share on Facebook
        </FacebookShareButton>
      </div>
      <div className="col-md-3">
        <TwitterShareButton className="btn btn-tw btn-block" url={`https://${window.location.host}/gateway/${currentApp.checksum}`}>
          Share on Twitter
        </TwitterShareButton>
      </div>
    </Modal>
