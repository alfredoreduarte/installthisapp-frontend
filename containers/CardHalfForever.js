...
// plan: basic
// coupon: half-price-forever
//
import React from 'react'
import TakeMoney from 'components/StripeButton'

const CardHalfForever = ({ busy, plan, onSuccess }) => (
	<div
		...
		<div
			...
			<div
				...
				<h1
					...
					Get the starter pack for half the price
				</h1>
				<p
					style={{
						textAlign: 'center',
					}}>
					Start now, pay in 7 days. Cancel whenever you want.
				</p>
			</div>
			<div>
			...
			<div className="col-md-12 text-center">
				{plan ? (
					<TakeMoney planId={plan.id} onSuccess={onSuccess} couponCode="half-price-forever">
						<button
...
export default CardHalfForever
