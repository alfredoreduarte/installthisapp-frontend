...
const CardAppLimit = ({ busy, plan, onSuccess }) => (
  <div
        ...
        <div className="col-md-6">
          ...
          <ul className="list-unstyled" style={{ lineHeight: 1.8, fontSize: '14px', marginLeft: '10px' }}>
            <li style={{ fontSize: '18px' }}>
              <span style={{ marginRight: '10px' }} className="glyphicon glyphicon-ok text-success" />Up to <b>5</b> contests at the
              same time
            </li>
            <li>
