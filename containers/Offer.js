...
const Offer = ({ type, busy, plan, onSuccess }) => {
  switch (type) {
    case 'half-forever':
      return <CardHalfForever busy={busy} plan={plan} onSuccess={onSuccess} />
    case 'starter':
      return <CardOverlay busy={busy} plan={plan} onSuccess={onSuccess} />
    case 'trial-ended':
      return <CardTrialEnded busy={busy} plan={plan} onSuccess={onSuccess} />
    case 'app-limit-reached':
      return <CardAppLimit busy={busy} plan={plan} onSuccess={onSuccess} />
    default:
      null
  }
}
