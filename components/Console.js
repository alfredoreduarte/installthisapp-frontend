  ...
  <div className="col-md-12">
    <div>
      <form className="form-inline" onSubmit={authenticatedGet}>
        ...
        <div className="form-group">
          <Field name="authenticatedGet" type="text" className="form-control" component="input" />
        </div>
      ...
      <form className="form-inline" onSubmit={authenticatedPost}>
        ...
        <div className="form-group">
          <Field name="authenticatedPost" type="text" className="form-control" component="input" />
        </div>
        <button type="submit" className="btn btn-default">
          POST
        </button>
      ...
      <form className="form-inline" onSubmit={anonGet}>
        ...
        <div className="form-group">
          <Field name="anonGet" type="text" className="form-control" component="input" />
        </div>
        <button type="submit" className="btn btn-default">
          GET
        </button>
