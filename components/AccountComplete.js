		...
		<div className="row">
			<div className="col-md-4 col-md-offset-4" style={{ marginTop: '60px' }}>
				<p className="text-center">
					<img src="/images/logo.jpg" className="img-rounded" style={{ width: '50px' }} />
				</p>
				<br />
				<br />
						...
						<div className="form-horizontal">
							<div className="form-group form-group-lg">
								...
								<div className="col-md-8">
									<Field name="name" type="text" className="form-control" component="input" />
								</div>
							</div>
						</div>
					</div>
					<div className="panel-footer">
						<button type="submit" className="btn btn-lg btn-success btn-block" disabled={fetching}>
							<b>{fetching ? 'Saving...' : 'Save and continue →'}</b>
						</button>
					</div>
				</div>
			</div>
