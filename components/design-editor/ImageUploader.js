...
const ImageUploader = ({ clear, value, property, onChange, handleChange }) => (
  <div className="ita-flex-box ita-flex-box-horizontal">
    <div className="ita-flex-box ita-flex-items-center ita-flex-shrink">
      <label>
        ...
        {property == 'header' && (
          <small className="ita-sidebar-image-tip">
            width: 820px<br />height: variable
          </small>
        )}
        {property == 'footer' && (
          <small className="ita-sidebar-image-tip">
        ...
        {property == 'logoDesktop' && (
          <small className="ita-sidebar-image-tip">
            width: variable<br />height: 50px
          </small>
        )}
        {property == 'logoMobile' && (
          <small className="ita-sidebar-image-tip">
            width: variable<br />height: 26px
          </small>
        )}
      </label>
    </div>
