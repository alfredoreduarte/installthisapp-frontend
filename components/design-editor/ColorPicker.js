...
const ColorPicker = ({
	...
	<div>
		...
		<label 
				htmlFor={property} className="ita-sidebar-col-50 text-right ita-color-picker-label">
			<div
				className="ita-color-picker-trigger" 
		...
		<div className="ita-color-picker-container" style={{
			background: 'white',
			padding: '0px',
			marginBottom: '10px',
			marginTop: '13px',
