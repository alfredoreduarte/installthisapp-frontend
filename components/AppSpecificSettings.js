          ...
          <div className="panel-body">
            <div className="form-horizontal">
              <div className="form-group">
                ...
                <div className="col-md-6">
                  <Field name={'pointsPerLike'} type="number" className="form-control" component="input" />
                </div>
              </div>
              <div className="form-group">
                <div className="col-md-6">
                ...
                <div className="col-md-6">
                  <Field name={'pointsPerComment'} type="number" className="form-control" component="input" />
                </div>
              </div>
              <div className="form-group">
                <div className="col-md-6">
                  ...
                  <p className="help-block">
                    Get the user's Facebook profile url from the scores list,<br /> and use the numeric part as in: fb.com/1234.<br />{' '}
                    Insert one comma between each value.
                  </p>
                </div>
                <div className="col-md-6">
                  <Field name={'ignoredUserIdentifiers'} type="text" className="form-control" component="textarea" rows="5" />
                </div>
              </div>
            </div>
          </div>
