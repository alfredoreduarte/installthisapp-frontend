		...
		<div className="editor-tab-item-body">
			<div className="form-horizontal">
				<p className="text-center">
					<b>This will show up when you share the app's URL on Facebook</b>
				</p>
				<hr />
				...
				<div className="form-group">
					...
					<div className="col-sm-10">
						...
						<p className="help-block">
							...
							At the minimum, you should use images that are 600 x 315 pixels to display link page posts with larger
							images.<br />
